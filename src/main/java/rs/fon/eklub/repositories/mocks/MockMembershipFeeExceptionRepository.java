 ...
 * @author milos
 */
public class MockMembershipFeeExceptionRepository implements DataAccessService<MembershipFee> {

    private List<MembershipFee> mockMembershipFeeExceptionRepository = new ArrayList<>();

    public MockMembershipFeeExceptionRepository() {
        ...
        mockMembershipFeeExceptionRepository.add(mf1);
        mockMembershipFeeExceptionRepository.add(mf2);
        mockMembershipFeeExceptionRepository.add(mf3);
    }
